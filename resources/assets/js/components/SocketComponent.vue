    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <button @click="sendData" class="btn btn-primary btn-xs text mt-1 mh-100">Obnovka</button>
            </div>
        </div>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        methods: {
            update: function () {
                axios.get('/vue-start/socket-chart').then((response) => {
